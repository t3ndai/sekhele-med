...
Mailjet.configure do |config|
  config.api_key = Rails.application.credentials.dig(:mailjet, :api_key) || ENV["MAILJET_API_KEY"]
  config.secret_key = Rails.application.credentials.dig(:mailjet, :secret_key) || ENV["MAILJET_SECRET_KEY"]
  config.default_from = "noreply@sekhele.com"
