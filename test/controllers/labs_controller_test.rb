...
class LabsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lab" do
    assert_difference("Lab.count") do
      post labs_url, params: { lab: { company_name: @lab.company_name, trading_name: @lab.trading_name } }
    end
  ...
  test "should update lab" do
    patch lab_url(@lab), params: { lab: { company_name: @lab.company_name, trading_name: @lab.trading_name } }
