<template>
  <form @submit.prevent="emit('onSubmit', form)" class="contents">
    <div class="my-5">
      ...
      <input type="number" name="amount_due" id="amount_due" v-model="form.amount_due" disabled
    ...
    <div class="my-5">
      ...
      <input type="number" name="amount_paid" id="amount_paid" v-model="form.amount_paid"
        class="block shadow rounded-md border border-gray-400 outline-none px-3 py-2 mt-2 w-full" />
    ...
    <div class="my-5">
      ...
      <input type="file" multiple name="proof[]" id="proof" @input="form.proof = Array.from($event.target.files)"
        class="block shadow rounded-md border border-gray-400 outline-none px-3 py-2 mt-2 w-full" />
    ...
    <div class="my-5">
      ...
      <Select :options="payment_methods" optionLabel="label" optionValue="value" type="text" name="payment_method"
        id="payment_method" v-model="form.payment_method"
        class="block shadow rounded-md border border-gray-400 outline-none px-3 py-2 mt-2 w-full" />
...
const { patient_visit_billing, submitText, payment_methods } = defineProps(['patient_visit_billing', 'submitText', 'payment_methods'])
